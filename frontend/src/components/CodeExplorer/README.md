# Code Explorer Component (Module 15)

Exposes the compiled folder trees and files.

## Submodules / Features

### 1. File Tree View (`FileTreeView.tsx`)
...
### 4. Traceability Link (`TraceabilityLink.tsx`)
Connects file nodes directly to originating requirements.
