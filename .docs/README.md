# Jinie Desktop Documentation Index

Welcome to the documentation for the **Jinie Desktop Application**. This directory contains guide docs and architecture specifications for developers working on the codebase.
...
*For codebase specific details, see the README files in the respective directories:*
